...
const translations = {
  ...
  en: {
    ...
    heroHeadline: 'Stay Simple • Stay Diverse',
    heroIntro: 'Focused on vision intelligence<br>building an innovation platform from theory to real-world impact.',
    ...
    keyTechHeading: 'Key Technologies & Latest Works',
    keyTechSubheading: ' ',
